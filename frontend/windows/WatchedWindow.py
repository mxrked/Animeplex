...
class WatchedWindow(QMainWindow):


    def __init__(self):
        super(WatchedWindow, self).__init__()

        uic.loadUi("frontend/ui/WatchedWindow.ui", self)
