...
class FavoritedWindow(QMainWindow):


    def __init__(self):
        super(FavoritedWindow, self).__init__()

        uic.loadUi("frontend/ui/FavoritedWindow.ui", self)
